...
int parseArg( std::string a, ICommandLineOptionCollector *pCol, bool fBuiltin, bool ignoreInfos)
{
    ...
    if (opt.isOption())
    {
        ...
        */
        ...
        else if (opt.isOption("no-ext") || opt.isOption('E') || opt.setDescription("Remove file extention from autogenerated C-lang var name"))
        {
            if (hasHelpOption) return 0;
        ...
        else if (opt.isOption("output-string") || opt.isOption("string") || opt.isOption('s') || opt.setDescription("Generate output as C-string"))
        {
            if (hasHelpOption) return 0;

            outputAsString = true;
        }
        else if (opt.isOption("output-array") || opt.isOption("array") || opt.isOption('a') || opt.setDescription("Generate output as byte array"))
        {
            if (hasHelpOption) return 0;
        ...
        else if (opt.isOption("linefeed-auto") || opt.isOption("auto-linefeed") || opt.isOption("auto") || opt.isOption('A') || opt.setDescription("Use line separator from source file"))
        {
            if (hasHelpOption) return 0;
        ...
        else if (opt.setParam("?FILENAME", "") || opt.isOption("filename") || opt.isOption('F') || opt.setDescription("Add resource file name variable. Parameter value is optional"))
        {
            if (hasHelpOption) return 0;
        ...
        else if (opt.setParam("?MIMETYPE", "") || opt.isOption("mime-type") || opt.isOption("mime") || opt.isOption('M') || opt.setDescription("Set mime type as taken. If no mime type explicitly taken, it will be autodetected"))
        {
            if (hasHelpOption) return 0;
        ...
        else if (opt.setParam(true) || opt.setInitial(false) || opt.isOption("base64") || opt.isOption('B') || opt.setDescription("Encode input file into base64"))
        {
            if (hasHelpOption) return 0;
        ...
        else if (opt.setParam("LEN", 0, 0, 100) || opt.setInitial(0) || opt.isOption("base64-len") || opt.setDescription("Set base64 encoded line max len"))
        {
            if (hasHelpOption) return 0;
        ...
        else if (opt.setParam(true) || opt.setInitial(true) || opt.isOption("base64-filling") || opt.setDescription("Add base64 filling chars at end"))
        {
            if (hasHelpOption) return 0;
        ...
        else if (opt.setParam("CLASSNAME") || opt.isOption("class") || opt.setDescription("* Generate (and set name) class for resource"))
        {
            if (hasHelpOption) return 0;
        ...
        else if (opt.setParam("SIZE", 16, 16, 120) || opt.setInitial(16) || opt.isOption("line-size") || opt.isOption('l') || opt.setDescription("Set max line size or number of array items per line"))
        {
            if (hasHelpOption) return 0;
        ...
        else if (opt.isOption("compress-ws") || opt.isOption('R') || opt.setDescription("Compress whitespaces - reduce multiple WS (\\s, \\t) to single"))
        {
            if (hasHelpOption) return 0;
